package br.com.empresa.votacao.exceptions;
...
public class GlobalExceptionHandler {
	  ...
	  public ResponseEntity<Map<String, List<String>>> handleNotFoundException(NomeDuplicadoException ex) {
	    List<String> errors = List.of(ex.getMessage());

	    return ResponseEntity.status(HttpStatus.CONFLICT).body(errorsMap(errors));
	  }
